...
Claude Code Plugins are lightweight packages that extend Claude Code functionality by bundling custom slash commands, specialized agents, hooks, and MCP (Model Context Protocol) servers into reusable, shareable components.
